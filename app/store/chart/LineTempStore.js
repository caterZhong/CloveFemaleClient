Ext.define("cfa.store.chart.LineTempStore", {
    ...
    config:{
	    ...
	    proxy: {
	        type: 'jsonp',
	        url : domain + 'FgChartTest/getLineTempStore',
	        extraParams:{
    ...
    previousData: function(){
        ...
        console.log("LineTempStore previousData Called") ;
    ...
    nextData: function(){
        ...
        console.log("LineTempStore nextData Called") ;
        this.loadNewData(params) ;
    }
});