Ext.define("cfa.store.chart.PieTempStore", {
    ...
    config:{
	    ...
	    proxy: {
	        type: 'jsonp',
	        url : domain + 'FgChartTest/getPieTempStore',
	        extraParams:{
    ...
    previousData: function(){
        ...
        console.log("PieTempStore previousData Called") ;
    ...
    nextData: function(){
        ...
        console.log("PieTempStore nextData Called") ;
        this.loadNewData(params) ;
    }
});