Ext.define("cfa.store.chart.PieBabyMoveStore", {
    ...
    config:{
	    ...
	    proxy: {
	        type: 'jsonp',
	        url : domain + 'FgChartTest/getPieBabyMoveStore',
	        extraParams:{
    ...
    previousData: function(){
        ...
        console.log("PieBabyMoveStore previousData Called") ;
    ...
    nextData: function(){
        ...
        console.log("PieBabyMoveStore nextData Called") ;
        this.loadNewData(params) ;
    }
});