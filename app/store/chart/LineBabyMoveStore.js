Ext.define("cfa.store.chart.LineBabyMoveStore", {
    ...
    previousData: function(){
        ...
        console.log("LineBabyMoveStore previousData Called") ;
    ...
    nextData: function(){
        ...
        console.log("LineBabyMoveStore nextData Called") ;
        this.loadNewData(params) ;
    }
});