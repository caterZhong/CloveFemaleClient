Ext.define("cfa.store.chart.LineGesWeightStore", {
    ...
    config:{
	    ...
	    proxy: {
	        type: 'jsonp',
	        url : domain + 'FgChartTest/getLineGesWeightStore',
	        extraParams:{
    ...
    previousData: function(){
        ...
        console.log("LineGesWeightStore previousData Called") ;
    ...
    nextData: function(){
        ...
        console.log("LineGesWeightStore nextData Called") ;
        this.loadNewData(params) ;
    }
});